...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        After <span className="font-medium">Diploma in Engineering in Computer Science</span>, I decided to continue my passion for programming & development. 
        I enrolled in a <span className="font-medium">Bachelor's of Technology in CSE</span> and learned 
        <span className="font-medium"> Full-stack web app development</span>. 
